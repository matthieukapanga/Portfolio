    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="Once we agree on the plan, i start my lofi playlist and dive into coding. From initial sketches to polished code, i keep you updated every step of the way."
        >
          <CanvasRevealEffect
            animationSpeed={3}
